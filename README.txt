...
Changelog
---------
Version 4.9.3.3: Take mandatory pitstop status into account when deriving expected post-pit opponent positions (assume opponents who still haven't pitted will pit this lap if we're at the end of the pit window); Added and corrected a few car classes (pCars2 and R3E); iRacing - fixed some car class allocation issues
