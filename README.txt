...
Changelog
---------
Version 4.8.2.6: Fixed some nAudio bugs that meant the radio beeps were being sent to the wrong audio device; added iRacing incident count voice commands ("how many incidents do i have" / "what's my incident count" and "what's the incident limit"); added Hong Kong track mappings (RF2 Formula E pack); fixed tyre temperature thresholds on some R3E car classes
