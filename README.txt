...
Changelog
---------
Version 4.9.2.6: Allow pit countdown past session finish (for cooldown lap); iRacing - improve live position tracking; iRacing - improve retired vehicle detection; iRacing - race finish position improvements
