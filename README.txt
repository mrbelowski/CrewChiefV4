...
Changelog
---------
Version 4.2.1.0: Added support for secondary driver names mappings file (so the autoupdater doesn't overwrite changes made to names.txt; Additional validation on R3E sector reports; Added "what's the fastest lap" and "what time is it" responses; A few bug fixes and minor improvements; Reworked R3E tyre temperature checking to make better use of the core temps provided by the game.
