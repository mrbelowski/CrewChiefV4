...
namespace CrewChiefV4.rFactor2
{
    ...
    {
        public const string MM_FILE_NAME1 = "$rFactor2SMMPBuffer1$";
        public const string MM_FILE_NAME2 = "$rFactor2SMMPBuffer2$";
        public const string MM_FILE_ACCESS_MUTEX = @"Global\$rFactor2SMMPMutex";
        public const int MAX_VSI_SIZE = 128;
    ...
    namespace rFactor2Data
    {
        ...
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 16)]
        public struct rF2VehScoringInfo
        {
            ...
            public double mYaw;                    // rad, use (360-yaw*57.2978)%360 for heading in degrees
            public double mPitch;                  // rad
            public double mRoll;                   // rad
            public double mSpeed;                  // meters/sec
      ...
      public rF2Vec3 mLocalRotAccel;        // rotational acceleration (radians/sec^2) in local vehicle coordinates
        ...
        public struct rF2State
        {
            ...
            public double mMaxImpactMagnitude;    // Max impact magnitude.  Tracked on every telemetry call, and reset on visit to pits or Session restart.
            public double mAccumulatedImpactMagnitude;  // Accumulated impact magnitude.  Tracked on every telemetry call, and reset on visit to pits or Session restart.
            ...
            public byte mInvulnerable;              // Indicates invulnerability 0 (off), 1 (on)
            ...
            public rF2VehScoringInfo[] mVehicles;  // array of vehicle scoring info's
